...
type HomeData = { products: Product[]; productCount: number; customerCount: number; reviewCount: number; avgRating: number; brandCount: number };

function formatSyp(value?: number | null) { return value ? `${Math.round(value).toLocaleString('ar-SY')} ل.س` : 'السعر عند الطلب'; }
